...
class LevelData:
    ...
    def __init__(self, level_num, left_wall, right_wall, objects):
        ...
        self.objects = objects        # list[dict] with x, y, type keys
        self.dirty = False

    @classmethod
    def from_game_data(cls, level_num):
        left, right = decode_level(level_num)
        raw_objs = get_objects(level_num)
        objects = [{"x": x, "y": y, "type": t} for x, y, t in raw_objs]
        return cls(level_num, list(left), list(right), objects)
